...
```
triangles in C₅            : none
independent triples in C₅  : none
```

So a five-vertex argument cannot prove `R(3,3) ≤ 6` even if the code had matched the prose. Both
the formalization and the informal argument fail, independently.
